...
11. Clip-wide shoulder and hip overlap independently identifies body side views. When strong, the rigid head is centered in the torso's sagittal plane and a robust clip-wide ankle width softly constrains lateral leg spread. Corrections are distributed across each thigh and shin without changing their visible sagittal directions.
