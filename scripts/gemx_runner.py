#!/usr/bin/env python3
"""Run the pinned GEM-X pipeline and export KineTrace-compatible motion data.
...
def main() -> None:
    ...
    if result_path.exists():
        ...
        # This cache is generated by the current local GEM-X job.
        prediction = torch.load(result_path)  # nosec B614
    else:
    ...
    # This cache is generated by the current local GEM-X job.
    keypoints = torch.load(cfg.paths.vitpose)  # nosec B614
